...
- 第三章数组 (前面略读了一下，看不下去了，明日再看,没有等到明日，今日继续)
  ...
  ```
  5. js数组常用方法
  ![pic](https://cdn.statically.io/gh/Justice996/picx-images-hosting@master/DataStructureAndalgorithm/1695260589327.kfxpwsgtrl8.webp)
  6. 数组合并concat方法，concat方法可以向一个数组传递数组、对象或是元素。数组会按照该方法传入的参数顺序连接指定数组。
   ...
   8. ES2015和ES2016新增的数组方法
      ![1695263963200](https://cdn.statically.io/gh/Justice996/picx-images-hosting@master/DataStructureAndalgorithm/1695263963200.40wce4zodes0.webp)
